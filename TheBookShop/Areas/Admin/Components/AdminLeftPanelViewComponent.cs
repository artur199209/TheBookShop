...
namespace TheBookShop.Areas.Admin.Components
{
    ...
    public class LeftNav
    {
        public IEnumerable<LeftNavItem> LeftPanel()
        {
            ...
            topNav.Add(new LeftNavItem() { Id = 1, NameOption = "Home Management", IsParent = true, ParentId = -1, IconClass = "fa fa-dashboard" });
            ...
            topNav.Add(new LeftNavItem() { Id = 3, NameOption = "Użytkownicy", IsParent = true, ParentId = -1, IconClass = "fas fa-users" });
            topNav.Add(new LeftNavItem() { Id = 4, Area = "Admin", Action = "Index", NameOption = "Wszyscy", Controller = "Account", IsParent = false, ParentId = 3, IconClass = "fa fa-circle-o" });
            topNav.Add(new LeftNavItem() { Id = 5, Area = "Admin", Action = "Create", NameOption = "Dodaj", Controller = "Account", IsParent = false, ParentId = 3, IconClass = "fa fa-circle-o" });

            topNav.Add(new LeftNavItem() { Id = 6, NameOption = "Autorzy", IsParent = true, ParentId = -1, IconClass = "fas fa-users" });
            ...
            topNav.Add(new LeftNavItem() { Id = 9, NameOption = "Pozycje", IsParent = true, ParentId = -1, IconClass = "fas fa-book" });
            ...
            topNav.Add(new LeftNavItem() { Id = 12, NameOption = "Zamówienia", IsParent = true, ParentId = -1, IconClass = "fab fa-first-order" });
